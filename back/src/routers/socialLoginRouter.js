...
var validation = __importStar(require("../middlewares/socialLoginValidationMiddleware"));
var socialLoginRouter = express.Router();
socialLoginRouter.post("/kakao", validation.validateCode, socialLoginController_1.default.kakaoOauth);
socialLoginRouter.post("/naver", validation.validateCode, socialLoginController_1.default.naverOauth);
socialLoginRouter.post("/google", validation.validateCode, socialLoginController_1.default.googleOauth);
