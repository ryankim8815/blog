...
var commentService = /** @class */ (function () {
    ...
    //// 모든 댓글 조회
    commentService.getAllComments = function () {
        return __awaiter(this, void 0, void 0, function () {
            var allComments, allCommentsString, allCommentsObject, i, result_success;
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0: return [4 /*yield*/, Comment_1.default.findAll()];
                    case 1:
                        allComments = _a.sent();
                        allCommentsString = JSON.stringify(allComments);
                        allCommentsObject = JSON.parse(allCommentsString);
                        for (i = 0; i < allCommentsObject.length; i++) {
