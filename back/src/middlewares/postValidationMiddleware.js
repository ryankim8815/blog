        ...
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0:
                    _a.trys.push([0, 2, , 3]);
                    params = req.params;
                    return [4 /*yield*/, postSchemas_joi_1.postListByTagSchema.validateAsync(params)];
                case 1:
                    _a.sent();
                    next();
                    return [3 /*break*/, 3];
...
exports.validatePostByTag = validatePostByTag;
var validatePostByPostId = function (req, res, next) {
    return __awaiter(this, void 0, void 0, function () {
        ...
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0:
                    _a.trys.push([0, 2, , 3]);
                    params = req.params;
                    return [4 /*yield*/, postSchemas_joi_1.postParamsSchema.validateAsync(params)];
                case 1:
                    _a.sent();
                    next();
                    return [3 /*break*/, 3];
        ...
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0:
                    _a.trys.push([0, 2, , 3]);
                    body = req.body;
                    return [4 /*yield*/, postSchemas_joi_1.postCreateSchema.validateAsync(body)];
                case 1:
                    _a.sent();
                    next();
                    return [3 /*break*/, 3];
        ...
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0:
                    ...
                    return [4 /*yield*/, postSchemas_joi_1.postUpdateSchema.validateAsync(body)];
                case 1:
                    _a.sent();
                    return [4 /*yield*/, postSchemas_joi_1.postParamsSchema.validateAsync(params)];
                case 2:
        ...
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0:
                    ...
                    body = req.body;
                    params = req.params;
                    return [4 /*yield*/, postSchemas_joi_1.postDeleteSchema.validateAsync(body)];
                case 1:
                    _a.sent();
                    return [4 /*yield*/, postSchemas_joi_1.postParamsSchema.validateAsync(params)];
                case 2:
