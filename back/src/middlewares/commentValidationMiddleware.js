        ...
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0:
                    ...
                    params = req.params;
                    body = req.body;
                    return [4 /*yield*/, commentSchemas_joi_1.paramsCommentDeleteSchema.validateAsync(params)];
                case 1:
                    _a.sent();
                    return [4 /*yield*/, commentSchemas_joi_1.bodyUserIdSchema.validateAsync(body)];
                case 2:
                    _a.sent();
                    next();
                    return [3 /*break*/, 4];
